...
\h{Referencing}
Here is a hyperlink to a \url{https://www.overleaf.com/}{webpage}. This is a reference to \at{my_equation}, and this refers to \at{my_svg}. You can also refer to headings like \at{Tables}. \At{my_code} is a capitalized variant. For all references, both the name and number are links. Of cource, you can cite sources using \c{\cite{...}}, like this \cite{minted} or this \cite{tabularray}. You can also insert a bibliography.
